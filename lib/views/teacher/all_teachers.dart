  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WidgetWithSidebar(
          context, cardOfUserTable(context,  AllTeachersTable())),
    );
  }
}
...
class AllTeachersTable extends StatefulWidget {
  AllTeachersTable({Key? key}) : super(key: key);
  @override
  State<AllTeachersTable> createState() => _AllTeachersTableState();
}

class _AllTeachersTableState extends State<AllTeachersTable> {
  ...
  List<Map<String, dynamic>> _generateData({int n = 50}) {
    ...
    for (var data in source) {
      temps.add({
        ...
        "section": "A$i",
        "shift": "Morning",
        "contact": "+923 ${i}$i$i$i$i",
        "email": "studybridge${i}@gmail.com",
      });
      i++;
    }
    return temps;
          ...
          Container(
            ...
            child: Card(
              ...
              child: ResponsiveDatatable(
                title: Row(
                  children: [
                    Text('All Teachers', style: MyTextStyles.headingLargePrimary,),
                    SizedBox(width: 10,),
                    TextButton.icon(
                      onPressed: () => {
