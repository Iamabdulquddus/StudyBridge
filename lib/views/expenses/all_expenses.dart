...
class AllExpensesTable extends StatefulWidget {
  const AllExpensesTable({Key? key}) : super(key: key);
  @override
  State<AllExpensesTable> createState() => _AllExpensesTableState();
}

class _AllExpensesTableState extends State<AllExpensesTable> {
