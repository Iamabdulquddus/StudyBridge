...
import '../content.dart';
import 'component/check_student.dart';
...
class AllStudentsTable extends StatefulWidget {
  AllStudentsTable({Key? key}) : super(key: key);
  @override
  State<AllStudentsTable> createState() => _AllStudentsTableState();
}

class _AllStudentsTableState extends State<AllStudentsTable> {
