...
class AllResultsTable extends StatefulWidget {
  AllResultsTable({Key? key}) : super(key: key);
  @override
  State<AllResultsTable> createState() => _AllResultsTableState();
}

class _AllResultsTableState extends State<AllResultsTable> {
