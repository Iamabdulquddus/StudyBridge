...
class FeeCollectionTable extends StatefulWidget {
  FeeCollectionTable({Key? key}) : super(key: key);
  @override
  State<FeeCollectionTable> createState() => _FeeCollectionTableState();
}

class _FeeCollectionTableState extends State<FeeCollectionTable> {
